...
def insert_accommodation(destination, location, accommodation1_path, place1, loc1, time1, more1,
                         accommodation2_path, place2, loc2, time2, more2,
                         accommodation3_path, place3, loc3, time3, more3):
    try:
        # MySQL query to insert data
        sql = "INSERT INTO suggestions (state, city, image1, place1, loc1, time1, more1, " \
              "image2, place2, loc2, time2, more2, " \
              "image3, place3, loc3, time3, more3) " \
              "VALUES (%s, %s, %s, %s, %s, %s, %s, " \
              "%s, %s, %s, %s, %s, %s, %s, %s, %s, %s)"
        # Tuple containing values to be inserted
        val = (
            destination, location, accommodation1_path, place1, loc1, time1, more1,
            accommodation2_path, place2, loc2, time2, more2,
            accommodation3_path, place3, loc3, time3, more3
        )
        # Execute the query
...
def create_uploadwindow(parent):
    ...
    enter_label3 = Label(uploadacc_window,
                         text="Enter the names of places",
                         fg='#f7f7f7',
                         bg='#111F4D',
                         font=font_option)
    enter_label3.grid(row=5, column=0, columnspan=3, padx=10, pady=10, sticky='n')

    entry_field3 = Entry(uploadacc_window, width=30, justify="left")
    entry_field3.grid(row=6, column=0, columnspan=3, padx=10, pady=10, sticky='w')

    entry_field4 = Entry(uploadacc_window, width=30, justify="left")
    entry_field4.grid(row=6, column=0, columnspan=3, padx=10, pady=10, sticky='n')

    entry_field5 = Entry(uploadacc_window, width=30, justify="left")
    entry_field5.grid(row=6, column=0, columnspan=3, padx=10, pady=10, sticky='ne')
    ...
    info.grid(row=7, column=0, columnspan=3, padx=10, pady=10, sticky='w')
    ...
    info2.grid(row=7, column=0, columnspan=3, padx=10, pady=10, sticky='n')
    ...
    info3.grid(row=7, column=0, columnspan=3, padx=10, pady=10, sticky='ne')

    enter_label3 = Label(uploadacc_window,
                         text="Enter the exact location of places",
                         fg='#f7f7f7',
                         bg='#111F4D',
                         font=font_option)
    enter_label3.grid(row=8, column=0, columnspan=3, padx=10, pady=10, sticky='n')

    entry_field7 = Entry(uploadacc_window, width=30, justify="left")
    entry_field7.grid(row=9, column=0, columnspan=3, padx=10, pady=10, sticky='w')

    entry_field8 = Entry(uploadacc_window, width=30, justify="left")
    entry_field8.grid(row=9, column=0, columnspan=3, padx=10, pady=10, sticky='n')

    entry_field9 = Entry(uploadacc_window, width=30, justify="left")
    entry_field9.grid(row=9, column=0, columnspan=3, padx=10, pady=10, sticky='ne')

    enter_label4 = Label(uploadacc_window,
                         text="Enter the timing of places",
                         fg='#f7f7f7',
                         bg='#111F4D',
                         font=font_option)
    enter_label4.grid(row=10, column=0, columnspan=3, padx=10, pady=10, sticky='n')

    entry_field10 = Entry(uploadacc_window, width=30, justify="left")
    entry_field10.grid(row=11, column=0, columnspan=3, padx=10, pady=10, sticky='w')

    entry_field11 = Entry(uploadacc_window, width=30, justify="left")
    entry_field11.grid(row=11, column=0, columnspan=3, padx=10, pady=10, sticky='n')

    entry_field12 = Entry(uploadacc_window, width=30, justify="left")
    entry_field12.grid(row=11, column=0, columnspan=3, padx=10, pady=10, sticky='ne')

    enter_label5 = Label(uploadacc_window,
                         text="Enter the more information of places",
                         fg='#f7f7f7',
                         bg='#111F4D',
                         font=font_option)
    enter_label5.grid(row=12, column=0, columnspan=3, padx=10, pady=10, sticky='n')

    entry_field13 = Entry(uploadacc_window, width=30, justify="left")
    entry_field13.grid(row=13, column=0, columnspan=3, padx=10, pady=10, sticky='w')

    entry_field14 = Entry(uploadacc_window, width=30, justify="left")
    entry_field14.grid(row=13, column=0, columnspan=3, padx=10, pady=10, sticky='n')

    entry_field15 = Entry(uploadacc_window, width=30, justify="left")
    entry_field15.grid(row=13, column=0, columnspan=3, padx=10, pady=10, sticky='ne')
    ...
    def save_data():
        try:
            ...
            loc1 = entry_field7.get()
            loc2 = entry_field8.get()
            loc3 = entry_field9.get()

            time1 = entry_field10.get()
            time2 = entry_field11.get()
            time3 = entry_field12.get()

            more1 = entry_field13.get()
            more2 = entry_field14.get()
            more3 = entry_field15.get()

            # Check if accommodation paths lists contain any elements
            accommodation1_path = accommodation1_paths[0] if accommodation1_paths else ''
            accommodation2_path = accommodation2_paths[0] if accommodation2_paths else ''
            accommodation3_path = accommodation3_paths[0] if accommodation3_paths else ''

            # Insert data into the database
            insert_accommodation(destination, location, accommodation1_path, place1, loc1, time1, more1,
                                 accommodation2_path, place2, loc2, time2, more2,
                                 accommodation3_path, place3, loc3, time3, more3)
            ...
            entry_field10.delete(0, tk.END)
            entry_field11.delete(0, tk.END)
            entry_field12.delete(0, tk.END)

            entry_field13.delete(0, tk.END)
            entry_field14.delete(0, tk.END)
            entry_field15.delete(0, tk.END)
    ...
    save_button.grid(row=14, column=0, columnspan=3, padx=10, pady=10, sticky='n')
    ...
    uploadacc_window.grid_rowconfigure(13, weight=0)
    uploadacc_window.grid_rowconfigure(14, weight=0)
